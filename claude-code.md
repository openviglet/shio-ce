...
# POST /mcp speaks JSON-RPC 2.0, rev 2025-06-18.
...
P2 The same three are also MCP tools: shio_context, shio_write. And resources a client can read directly: shio://manifest, shio://context, shio://ops.
...
It does not make MCP the only door. Every capability lands on MCP, the CLI and REST, in that order and by law. A reader who does not use Claude Code loses the skills and the slash commands, and nothing else. P1
